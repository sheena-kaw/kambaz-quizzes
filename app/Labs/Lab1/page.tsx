...
summarize the topic of the section it precedes. For instance this paragraph is preceded by the 
heading Heading Tags. The font of the section headings are usually larger and bolder than their subsection headings. 
...
browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        My favorite recipe:
        <ol id="wd-pina-colada">
            <li>2 oz light rum</li>
            <li>3 oz coconut cream</li>
            <li>6 oz pinapple juice</li>
            <li>2 cups crushed ice</li>
            <li>2 pinapple slices</li>
        </ol>
        ...
        <ul id="wd-your-books">
            <li>At the Edge of the Universe</li>
            <li>Trick</li>
            <li>Harry Potter</li>
...
<               input type="number"
            ...
            Please
            <a href="https://github.com/ScarlettBlaize/kanbas-next-js" id="wd-github"> click here </a>
            to go to my github page<br/>
